...
pub use resolver::{
    build_scope_for_module, declaration_symbol_identity_info, declaration_uid_order,
    effective_auto_import_entries, effective_visible_entries, lower_module_source_ast,
