...
pub use resolver::{
    ...
    lowered_module_is_impl_owner, precollect_declaration_index, precollect_declarations,
    precollect_owner_registry, resolve, resolve_staged_program, resolve_staged_program_from_state,
