...
pub use semantic::{
    ...
    rank_completion_candidates_by_expected_type, repl_assist_at_cursor, repl_completion_use_site,
    signature_help_at_cursor, symbol_capabilities_for_builtin_surface,
    symbol_capabilities_for_declaration_entry, symbol_identity_for_builtin_surface,
    symbol_identity_for_declaration_entry, symbol_semantic_info_for_effective_visible_entry,
    ...
    ReplCommandUseSite, ReplCompletionUseSite, ReplInputSupport, ReplInputSupportContext,
