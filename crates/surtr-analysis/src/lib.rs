...
pub use semantic::{
    ...
    rank_completion_candidates_by_expected_type, repl_assist_at_cursor,
    repl_completion_use_site, signature_help_at_cursor,
    ...
    FacetPathRootKind, InputSignatureHelp, ReplAssist, ReplCommandUseSite,
    ReplCompletionUseSite, ReplInputSupport, ReplInputSupportContext, ReplInputSupportUpdate,
    SemanticIndex, SignatureLookup, SourceLocation, SymbolDisplayMetadata, SymbolLookup,
    SymbolSemanticInfo,
};
pub use service::{
