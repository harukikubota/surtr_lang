    ...
    while i < len {
        ...
        if c.is_ascii_alphabetic() || c == '_' {
            ...
            let token = match text.as_str() {
                ...
                "defgenserver" => Token::Defgenserver,
                "defsupervisor" => Token::Defsupervisor,
                "defdynamic_supervisor" => Token::DefdynamicSupervisor,
                "supervisor_init" => Token::SupervisorInit,
                "defmod" => Token::Defmod,
...
mod tests {
    ...
    fn test_two_char_ops() {
        ...
        assert!(matches!(tokens[3].token, Token::EqEq));
